...
export default {
	...
	CorpFlagship: {
		...
		BuildCost: 0,
		DesignUpgradeCost: [
			200000, 600000, 2000000, 5000000, 20000000, 40000000, 60000000, 80000000,
			100000000, 140000000, 180000000, 220000000, 260000000, 300000000,
			350000000,
		],
		DesignUpgradeTime: 0,
		RequiredPlanetLevel: 0,
		HP: [
			5000, 5500, 6050, 6650, 7300, 8000, 8800, 9700, 10700, 11800, 13000,
			14200, 15600, 17500, 20000,
		],
		Speed: 80,
