...
import {aggregateOutput, chanceToDie, destinyCover, solveSingleAttacker} from "./mechanics";
...
const defender3 = new Ship("useless1", 'bs', 9000, 15000, 0, 0);
...
export const test = () => {
    ...
    console.log(chanceToDie(aggregateOutput(solveSingleAttacker(destinyCover(attacker), [defender1, defender2, drone1, drone2]))))
