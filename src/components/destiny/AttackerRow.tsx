...
const AttackerRow = (props: {ship: Attacker, modShip: (ship: Attacker) => void}) => {
    ...
    return (<Stack direction="row" justifyContent="flex-start" alignItems="center" spacing={2}>
        <CardHeader title={"Attacker"} subheader={`x: ${props.ship.coordinate.x} y: ${props.ship.coordinate.y}`} />
        <FormControl>
