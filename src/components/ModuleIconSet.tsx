...
const url = (iconName: string) =>
	`https://github.com/userXinos/HadesSpace/blob/master/src/img/game/Modules/${iconName}.png?raw=true`;

const ModuleIconSet = (props: {
	mods: ModuleArtifactInfo[];
	selected: ModuleArtifactInfo | undefined;
	setSelected: (module: ModuleArtifactInfo) => void;
}) => {
	const mods = useMemo(() => {
