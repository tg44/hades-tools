...
const BoxStack: FC<ChainProps & { C1: FC<ChainProps>, currentDepth: number, maxDepth: number }> = ({
                                                                                                       prevLevel,
                                                                                                       prevNr,
                                                                                                       hUsageProps,
                                                                                                       lvlCb,
    ...
    if (currentDepth === maxDepth) {
        return <C1 prevLevel={prevLevel} prevNr={prevNr} hUsageProps={hUsageProps} lvlCb={lvlCb} nrCb={nrCb} tripCb={tripCb}/>
    } else {
        return <>
            <C1 prevLevel={prevLevel} prevNr={prevNr} hUsageProps={hUsageProps}
                lvlCb={setMiddleLvl}
                nrCb={setMiddleNr}
